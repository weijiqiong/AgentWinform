...
namespace AgentWinform.Common
{
    ...
    { /// <summary>
      // <summary>
        ...
        public static void ZoomAuto(string fromFile, string savePath, System.Double targetWidth, System.Double targetHeight, List<TextAddModel> watermarkText, ImgAddModel watermarkImage)
        {
            //创建目录
            ...
            if (initImage.Width <= targetWidth && initImage.Height <= targetHeight)
            {
                ...
                if (watermarkText != null)
                {
                    using (System.Drawing.Graphics gWater = System.Drawing.Graphics.FromImage(initImage))
                    {
                        ...
                        foreach (var item in watermarkText)
                        {
                            gWater.DrawString(item.Text, item.fontWater, item.brushWater, item.Point.X, item.Point.Y);
                ...
                if (watermarkImage.Image != null)
                {
                    ...
                    //获取水印图片
                    using (System.Drawing.Image wrImage = watermarkImage.Image)
                    {
                        ...
                        if (initImage.Width >= wrImage.Width && initImage.Height >= wrImage.Height)
                        {
                            ...
                            gWater.DrawImage(wrImage, new Rectangle(watermarkImage.Point.X, watermarkImage.Point.Y, wrImage.Width, wrImage.Height), 0, 0, wrImage.Width, wrImage.Height, GraphicsUnit.Pixel, imgAttributes);
            ...
            else
            {
                ...
                if (watermarkText != null)
                {
                    using (System.Drawing.Graphics gWater = System.Drawing.Graphics.FromImage(newImage))
                    {
                        ...
                        //文字抗锯齿
                        gWater.TextRenderingHint = System.Drawing.Text.TextRenderingHint.AntiAlias;
                        System.Drawing.Font fontWater = new Font("黑体", 10);
                        System.Drawing.Brush brushWater = new SolidBrush(Color.White);
                        foreach (var item in watermarkText)
                        {
        ...
        public static Image ZommImg(Image bmpOut, int destWidth, int destHeight)
        {
